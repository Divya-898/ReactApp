  ...
  return (
   <>
    ...
    <div style={{float:"right"}}>
      ...
      >
        <MenuItem ><Button variant="contained" color="success" onClick={handleClickOpen('paper')} sx={{float:"right",padding:"0"}}>Edit</Button> </MenuItem>
        <MenuItem > <Button variant="contained" color="error" onClick={handleClickOpen1} sx={{float:"right",padding:"0"}}>delete</Button></MenuItem>
